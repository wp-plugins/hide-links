...
Добавляет специальный шорткод `[link]`, c помощью которого можно скрыть  внешнюю ссылку в тексте статьи.
...
1. В тексте статьи добавьте шорткод с текстом будущей ссылки: 
...
1. При включенном плагине ссылки авторов комментариев или ссылки, заключенные в тег `[link]` будут выглядеть в исходном коде примерно так:
...
= 1.0.2 =
*   Исправлена ошибка с установкой класса для ссылки автора комментария


= 1.0.1 =
*   Исправлена критическая ошибка с установкой класса для тега span с картинкой внутри
*   В тексте комментария и втекстовом виджете теперь можно использовать шорткод `[link][/link]` для закрытия ссылок, добавив его вокруг html-кода стандартной гиперссылки
